...
Hx=single((zeros(nxp1,nyp1,nzp1)));
Hy=single((zeros(nxp1,nyp1,nzp1)));
Hz=single((zeros(nxp1,nyp1,nzp1)));
Ex=single((zeros(nxp1,nyp1,nzp1)));
Ey=single((zeros(nxp1,nyp1,nzp1)));
Ez=single((zeros(nxp1,nyp1,nzp1)));
...
SH_1=(ones(nxp1,nyp1,nzp1,'logical'));
SH_2=(ones(nxp1,nyp1,nzp1,'logical'));
SH_3=(ones(nxp1,nyp1,nzp1,'logical'));
...
sh_2=(ones(nxp1,nyp1,nzp1,'logical'));
sh_3=(ones(nxp1,nyp1,nzp1,'logical'));
source=single(zeros(nxp1,nyp1,nzp1,'logical'));
...
clearvars -except Hx Hy Hz Ex Ey Ez ...
    ...
    cpml_a1_mz_zp=gather(cpml_a1_mz_zp);  
      ...
      Psi_eyx_xn=gather(Psi_eyx_xn); 
      Psi_eyx_xp=gather(Psi_eyx_xp); 
      Psi_ezx_xn=gather(Psi_ezx_xn); 
      Psi_ezx_xp=gather(Psi_ezx_xp); 
      Psi_ezy_yn=gather(Psi_ezy_yn); 
      Psi_ezy_yp=gather(Psi_ezy_yp); 
      Psi_exy_yn=gather(Psi_exy_yn); 
      Psi_exy_yp=gather(Psi_exy_yp); 
      Psi_eyz_zn=gather(Psi_eyz_zn); 
      Psi_eyz_zp=gather(Psi_eyz_zp); 
      Psi_exz_zn=gather(Psi_exz_zn); 
      Psi_exz_zp=gather(Psi_exz_zp); 
      
      Psi_hyx_xn=gather(Psi_hyx_xn); 
      Psi_hyx_xp=gather(Psi_hyx_xp); 
      Psi_hzx_xn=gather(Psi_hzx_xn); 
      Psi_hzx_xp=gather(Psi_hzx_xp); 
      Psi_hzy_yn=gather(Psi_hzy_yn); 
      Psi_hzy_yp=gather(Psi_hzy_yp); 
      Psi_hxy_yn=gather(Psi_hxy_yn); 
      Psi_hxy_yp=gather(Psi_hxy_yp); 
      Psi_hyz_zn=gather(Psi_hyz_zn); 
      Psi_hyz_zp=gather(Psi_hyz_zp); 
      Psi_hxz_zn=gather(Psi_hxz_zn); 
      Psi_hxz_zp=gather(Psi_hxz_zp);       
...
Ex(:,:,n_cpml_zn+10)=Ex(:,:,n_cpml_zn+10)+sin(omega.*number.*dt);
